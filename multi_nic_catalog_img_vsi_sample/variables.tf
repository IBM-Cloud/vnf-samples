...
variable "primary_subnet_id"{
  default = ""
  description =" The id of the primary subnet to which Ubuntu VSI's interface belongs to"
}
...
##############################################################################
# vnf_vpc_image_name - The name of the vsi image name. Valid values are "bigip-14-1-2-6-0-0-2-all-1slot", "bigip-14-1-2-6-0-0-2-ltm-1slot", "bigip-15-1-0-4-0-0-6-all-1slot", "bigip-15-1-0-4-0-0-6-ltm-1slot" 
##############################################################################
variable "vnf_vpc_image_name" {
  default     = "bigip-14-1-2-6-0-0-2-all-1slot"
  description = "The name of the f5 big ip image name."
}
